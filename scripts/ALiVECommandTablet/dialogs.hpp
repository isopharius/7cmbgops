...
class Spyder_TacticalCommandMain
{
	idd = 723;
	movingEnable = 0;
   	 onLoad = "['main'] spawn STC_fnc_onLoad";
	onUnload = "['main'] spawn STC_fnc_unLoad";
	class controls 
	{
		...
		class SpyderCommandTablet_BattlefieldAnalysisExecute: STCRscButtonGreen
		{
			...
			action = "[] spawn STC_fnc_executeAnalysis";
		...
		class SpyderCommandTablet_AvailableMissionsExecute: STCRscButtonGreen
		{
			...
			action = "[] spawn STC_fnc_executeMission";
...
class Spyder_TacticalCommandGroupManager
{
	idd = 724;
	movingEnable = 0;
   	 onLoad = "['groupmanager'] spawn STC_fnc_onLoad";
	onUnload = "['groupmanager'] spawn STC_fnc_unLoad";
	class controls 
	{
		class SpyderCommandTablet_Background : STCRscPicture
		{
		...
		{
			idc = 7247;
			action = "[] spawn STC_fnc_changeFormation";
		...
		{
			idc = 7249;
			action = "[] spawn STC_fnc_changeBehavior";
		...
		{
			idc = 72410;
			action = "['remove'] call STC_fnc_removeUnit";
		...
		{
			idc = 72411;
			action = "['delete'] call STC_fnc_removeUnit";
...
class Spyder_TacticalCommandHighCommand
{
	idd = 725;
	movingEnable = 0;
   	 onLoad = "['highcommand'] spawn STC_fnc_onLoad";
	onUnload = "['highcommand'] spawn STC_fnc_unLoad";
	class controls 
	{
		...
		{
			idc = 7257;
			action = "[] spawn STC_fnc_confirmWaypoints";
		...
		{
			idc = 7258;
			action = "[] spawn STC_fnc_clearWaypoints";
...
class Spyder_TacticalCommandWaypointSettings
{
	idd = 726;
	movingEnable = 0;
   	 onLoad = "['waypointsettings'] spawn STC_fnc_onLoad";
	onUnload = "";
	class controls 
	{
		...
		{
			idc = 7262;
			action = "[] spawn STC_fnc_updateWaypointSettings";
