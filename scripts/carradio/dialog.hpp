...
class CLAY_CarRadio_RadioDlg
{
	...
	class CLAY_RADIO_ButtonVolUp: CLAY_RscRadioButton
	{
		idc = 603;
		text = "+";
		action = "['volUp'] call seven_fnc_settings";
		x = 0.125;
		y = 0.415;
		w = 0.05;
		h = 0.05;
	...
	class CLAY_RADIO_ButtonVolDown: CLAY_RscRadioButton
	{
		idc = 604;
		text = "-";
		action = "['volDown'] call seven_fnc_settings";
		x = 0.125;
		y = 0.535;
		w = 0.05;
		h = 0.05;
	...
	class CLAY_RADIO_ButtonPlayPause: CLAY_RscRadioButton
	{
		idc = 626;
		text = ">";
		action = "['play'] call seven_fnc_controls";
		x = 0.125;
		y = 0.475;
		w = 0.05;
		h = 0.05;
	...
	class CLAY_RADIO_ButtonPre: CLAY_RscRadioButton
	{
		idc = 615;
		text = "<<";
		action = "['pre'] call seven_fnc_controls";
		x = 0.77;
		y = 0.475;
		w = 0.05;
		h = 0.05;
	...
	class CLAY_RADIO_ButtonNext: CLAY_RscRadioButton
	{
		idc = 616;
		text = ">>";
		action = "['next', 1] execVM '\CLAY_CarRadio\scripts\controls.sqf'";
		x = 0.83;
		y = 0.475;
		w = 0.05;
		h = 0.05;
	...
	class CLAY_RADIO_ButtonSourceUp: CLAY_RscRadioButton
	{
		idc = 617;
		text = "/\";
		action = "['sourceUp'] call seven_fnc_settings";
		x = 0.8;
		y = 0.415;
		w = 0.05;
		h = 0.05;
	...
	class CLAY_RADIO_ButtonSourceDown: CLAY_RscRadioButton
	{
		idc = 618;
		text = "\/";
		action = "['sourceDown'] call seven_fnc_settings";
		x = 0.8;
		y = 0.535;
		w = 0.05;
		h = 0.05;
	...
	class CLAY_RADIO_ButtonPlayList: CLAY_RscRadioButton
	{
		idc = 620;
		text = "Playlist";
		action = "[] call seven_fnc_playlist";
		x = 0.21;
		y = 0.625;
		w = 0.08;
		h = 0.05;
	...
	class CLAY_RADIO_ButtonRepeatSelect: CLAY_RscRadioButton
	{
		idc = 621;
		text = "Repeat";
		action = "['playRepeat'] call seven_fnc_settings";
		x = 0.3;
		y = 0.625;
		w = 0.08;
		h = 0.05;
	...
	class CLAY_RADIO_ButtonRandomSelect: CLAY_RscRadioButton
	{
		idc = 622;
		text = "Random";
		action = "['playRandom'] call seven_fnc_settings";
		x = 0.39;
		y = 0.625;
		w = 0.08;
		h = 0.05;
	...
	class CLAY_RADIO_ButtonKeyColorSelect: CLAY_RscRadioButton
	{
		idc = 623;
		text = "Key Col";
		action = "['kCol'] call seven_fnc_settings";
		x = 0.48;
		y = 0.625;
		w = 0.08;
		h = 0.05;
	...
	class CLAY_RADIO_ButtonDisplayColorSelect: CLAY_RscRadioButton
	{
		idc = 624;
		text = "Dspl Col";
		action = "['dCol'] call seven_fnc_settings";
		x = 0.57;
		y = 0.625;
		w = 0.08;
		h = 0.05;
	...
	class CLAY_RADIO_ButtonBackgroundColorSelect: CLAY_RscRadioButton
	{
		idc = 625;
		text = "Design";
		action = "['Color'] call seven_fnc_settings";
		x = 0.66;
		y = 0.625;
		w = 0.08;
		h = 0.05;
...
class CLAY_CarRadio_PlaylistDlg
{
	...
	class CLAY_RADIO_ListPlaylistTracks: CLAY_RscRadioListbox
	{
		...
		w = 0.3;
		h = 0.65;
		onLBDrop = "nul = _this call seven_fnc_lbdrop";
	};
	...
	class CLAY_RADIO_ButtonAddSingle: CLAY_RscRadioButton
	{
		idc = 634;
		text = "<";
		action = "['addSingle'] call seven_fnc_editor";
		x = 0.48;
		y = 0.4;
		w = 0.04;
		h = 0.04;
	...
	class CLAY_RADIO_ButtonAddAll: CLAY_RscRadioButton
	{
		idc = 635;
		text = "<<";
		action = "['addAll'] call seven_fnc_editor";
		x = 0.48;
		y = 0.51;
		w = 0.04;
		h = 0.04;
	...
	class CLAY_RADIO_ButtonRemoveSingle: CLAY_RscRadioButton
	{
		idc = 636;
		text = ">";
		action = "['removeSingle'] call seven_fnc_editor";
		x = 0.48;
		y = 0.45;
		w = 0.04;
		h = 0.04;
	...
	class CLAY_RADIO_ButtonRemoveAll: CLAY_RscRadioButton
	{
		idc = 637;
		text = ">>";
		action = "['removeAll'] call seven_fnc_editor";
		x = 0.48;
		y = 0.56;
		w = 0.04;
		h = 0.04;
	...
	class CLAY_RADIO_ButtonOK: CLAY_RscRadioButton
	{
		idc = 638;
		text = "OK";
		action = "['create'] call seven_fnc_editor";
		x = 0.45;
		y = 0.825;
		w = 0.1;
		h = 0.05;
	...
	class CLAY_RADIO_ButtonCancel: CLAY_RscRadioButton
	{
		idc = 639;
		text = "Cancel";
		action = "[] spawn {closeDialog 0; sleep 0.1; [] spawn seven_fnc_radio";
		x = 0.575;
		y = 0.825;
		w = 0.1;
		h = 0.05;
	...
	class CLAY_RADIO_ButtonRestore: CLAY_RscRadioButton
	{
		idc = 640;
		text = "Restore";
		action = "['restore'] call seven_fnc_editor";
		x = 0.325;
		y = 0.825;
		w = 0.1;
		h = 0.05;
