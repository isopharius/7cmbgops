...
if(count _doorArr > 0) then {
	...
	private _actStatus = [SAF_STR_BREACH_PUTINGCHARGE,10,player,[getPos player,5]] call seven_fnc_showStatus;
	...
	if (_actStatus) then {
		...
		private _actId = player addAction [_actionTxt,seven_fnc_breachDetonate,[_c4,_doorArr],6,true,true,""];
