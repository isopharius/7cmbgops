...
if (_asset isEqualTo dtaControlledAssetLocal) exitWith {[_prePlotted] execVM "\7cmbgops\scripts\Artillery\Dialog\Control.sqf"};
...
if ((dtaHaveAimpoint) OR (dtaPrePlotted)) then {
	...
	sleep 1;
	[_prePlotted] execVM "\7cmbgops\scripts\Artillery\Dialog\Control.sqf";
	sleep 1;
