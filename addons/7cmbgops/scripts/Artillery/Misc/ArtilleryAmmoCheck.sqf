...
private["_vehicleType","_mortars","_typeToCount","_ammo","_rounds","_totalRounds","_index","_max","_out","_mag"];
disableSerialization;
params ["_vehicle", "_warheadType"];
...
if (_vehicleType in dtaTypes230mm) then {
	if (_warheadType == "Rockets") then {_typeToCount = "12Rnd_230mm_Rockets"};
};

if (_vehicleType in dtaTypes230mmD) then {
	if (_warheadType == "Rockets") then {_typeToCount = "DTA_12Rnd_230mm_Rockets"};
};
