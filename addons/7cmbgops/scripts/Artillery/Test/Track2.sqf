private ["_p","_tr1","_tr2","_vec","_col","_i","_no"];
...
while {_i<_no} do {
	drop [
		["\A3\data_f\ParticleEffects\Universal\Universal", 16, 7, 48], "", "Billboard", 1, 5, [0, - 1.3, 0],
		[-0.2+random 0.2,-0.6*_i + random 0.5,-0.2+random 0.2], 1, 1, 0.80, 0.4, [0.4,(0.8*_i)+random 0.2],_col,[2,0.7,0.5],0.1,0.1,"","",_this
	];
	_i=_i+1;
};

if ((abs(_p select 2) < 2) and !(surfaceiswater _p)) then {
	_vec = vectordir _this;
	_no= 20 + random 7;
	_i=0;
	while {_i<_no} do {
		drop [
			["\A3\data_f\ParticleEffects\Universal\Universal.p3d", 16, 12, 13, 0], "", "Billboard", 1, 7,
