...
// [[[],"\7cmbgops\scripts\AL_storm\alias_dust_wall.sqf"],"BIS_fnc_execVM",true,false] spawn BIS_fnc_MP;

if (!hasInterface) exitWith {};

params ["_sursa_storm", "_duration_duststorm_w"];
...
private _fum_negru = "#particlesource" createVehicleLocal [0,0,0];
_fum_negru setPosWorld (getPosWorld _sursa_storm);
